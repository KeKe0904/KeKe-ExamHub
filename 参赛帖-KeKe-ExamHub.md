...
做这个项目的初衷其实很简单——**我自己就是学生，我知道考试信息有多容易搞丢**。通知纸丢了、黑板擦了、群消息翻不到了…… 这些痛点我每天都在经历。

既然有痛点，又刚好会写代码，那就自己动手解决吧。用 TRAE IDE 从零开始搭，从 8 张表写到 20 张表，从只能看考试列表到五端协同，不知不觉就做了这么大。
