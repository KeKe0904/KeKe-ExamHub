...
> 17 岁，高二在读，科技爱好者，喜欢用代码解决身边的问题。

大家好，我是**落梦陳 (KeKe0904)**，一名普通的高中生。平时喜欢折腾各种技术，从写脚本、搭服务器到玩机器人，什么都想试一下。对新鲜事物充满好奇心，热衷于把想法变成能跑的代码。

真正让我系统性接触 AI 的，是 **AstrBot**（一个开源的聊天机器人框架）。那时候想用 AI 做个 QQ 机器人，在群里自动回答问题、提供便捷服务。为了让机器人更智能，开始研究 LLM、Prompt、插件开发…… 一发不可收拾。

从"让 AI 在群里回答问题"到"用 AI 写一个完整的全栈项目"，AstrBot 是我真正的 AI 入门启蒙。也正是因为这段开发机器人的经历，让我对 AI 能做什么、不能做什么有了第一手体感。
