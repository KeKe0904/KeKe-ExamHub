...
const ACTION_LABELS: Record<string, string> = {
  ...
  domain_update: "更新域名",
  domain_delete: "删除域名",
  domain_cert_issue: "申请证书",
  ip_blacklist_add: "封禁 IP",
  ip_blacklist_update: "更新封禁 IP",
  ip_blacklist_delete: "解封 IP",
  abnormal_login_review: "审核异常登录",
  classroom_abnormal_login: "教室端异常登录",
  teacher_create: "添加教师",
  teacher_update: "更新教师",
  teacher_delete: "删除教师",
  teacher_role_create: "添加教师身份",
  teacher_role_update: "更新教师身份",
  teacher_role_delete: "删除教师身份",
  classroom_countdown_create: "添加教室倒计时",
  classroom_countdown_update: "更新教室倒计时",
  classroom_countdown_delete: "删除教室倒计时",
};
