...
export default function Buildings() {
  ...
  const [deleteTarget, setDeleteTarget] = useState<BuildingType | null>(null);
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        ...
                        className="p-2 text-zinc-500 dark:text-zinc-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950 rounded-lg transition-colors btn-press"
                        aria-label="删除"
                      >
